...
const { generateToken, addUser, performLogin, setCookieToken, execute, isTable } = require("./utilz.js")
...
router.get("/logout", (req, res, next) => {
    execute("delete from user_login_tokens where token=?", [req.cookies.utoken]);
